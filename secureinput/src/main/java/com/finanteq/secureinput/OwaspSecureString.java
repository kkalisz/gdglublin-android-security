 ...
 * @author cam
 */
public class OwaspSecureString implements CharSequence {
  private final char[] chars;

  public OwaspSecureString(char[] chars){
    this.chars = new char[chars.length];
    System.arraycopy(chars, 0, this.chars, 0, chars.length);
  }

  public OwaspSecureString(char[] chars, int start, int end){
  ...
  public CharSequence subSequence(int start, int end) {
    return new OwaspSecureString(this.chars, start, end);
  }
